...
function ImagesTab() {
  const images = [
    { title: "Your sweet eyes have mesmerized me from the day we met.", src: "https://drive.google.com/thumbnail?id=1iuJKHY-VMFFg9LqTt0rEzOTFdnuUv3Fg&sz=w1200" },
    { title: "Having you in my arms feels like a blessing", src: "https://drive.google.com/thumbnail?id=1gXfiEQ4ouMZhB_20-8sRZq1eakKCWBTT&sz=w1200" },
    { title: "My current progress to make you the proudest girlfriend, much more better progress when I do come back <3", src: "https://drive.google.com/thumbnail?id=1y3nwP_xgWhJBJF324gLipq8-I4iQyb_D&sz=w1200" }
  ];
      ...
      {images.map((img, i) => (
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 z-20 bg-gradient-to-t from-black/98 via-black/60 to-transparent">
            <h3 className="font-sans font-medium tracking-wide text-sm md:text-base text-pink-100/90 drop-shadow-md">{img.title}</h3>
          </div>
        </motion.div>
      ))}
          ...
          >
            ...
            >
              ...
              <motion.h3 
                ...
                transition={{ delay: 0.3 }}
                className="absolute bottom-4 md:bottom-8 left-0 right-0 text-center font-sans font-medium tracking-wide text-sm md:text-xl text-white text-glow mx-4 md:mx-auto max-w-2xl bg-black/60 p-4 rounded-xl backdrop-blur-md border border-pink-500/20"
              >
